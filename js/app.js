...
window.addEventListener('scroll', function () {
    ...
    if (window.innerWidth > 992) {
        document.querySelectorAll('.section-anim').forEach(function (el, i) {
            if (el.offsetTop - document.querySelector('.header__nav').clientHeight - 180 <= scrollDistance) {
                ...
                document.querySelectorAll('.header__nav li')[i].querySelector('a').classList.add('header__nav-link--active');
            }
        });
    }
});
...
// VIDEO ========================
let videoSrc = 'video/Abstraction.mp4';
